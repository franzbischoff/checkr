...
```{r}
right_1 <- for_examiner(quote(2 + 2))
right_2 <- for_examiner(quote(`+`(2, 2)))
wrong_1 <- for_examiner(quote(2 * 2))
wrong_2 <- for_examiner(quote(3 + 1))
wrong_3 <- for_examiner(quote(2 + 5))
```
...
```{r}
right_1 <- for_examiner(quote(cos(pi / 2)))
wrong_1 <- for_examiner(quote(sin(pi / 2))) # using wrong trig function
wrong_2 <- for_examiner(quote(cos(90))) # using degrees
wrong_3 <- for_examiner(quote(cos(pi))) # wrong value
wrong_4 <- for_examiner(quote(cos(pi, 2))) # wrong calling syntax
wrong_5 <- for_examiner(quote(cos(3.14 / 2))) # bad approximation
```
